...
//    screenFrame2.origin.y = CGRectGetMidY(screenFrame2);
//    
//    UIImageView * backgroundImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"BG"]];
//    backgroundImageView.frame =  CGRectMake(20.0,
//                                            screenFrame2.origin.y+15,
...
//    _label.frame = CGRectMake(sliderWidth,
...
{	
    ...
    CFStringRef font_name = CFStringCreateWithCString(NULL, [self.font.fontName UTF8String], kCFStringEncodingMacRoman);
    
    CTFontRef font = CTFontCreateWithName(font_name, 44.0, NULL);
    ...
    CGPoint textEnd = CGPointMake(self.frame.size.width, 0);// CGContextGetTextPosition(theContext);
    ...
    CGColorRef textColor = [UIColor whiteColor].CGColor;//self.textColor.CGColor;
    ...
    CGContextSetTextPosition( theContext, 0, (size_t)self.font.ascender );
